/*1651150296,,JIT Construction: v1005426871,en_US*/
...
try {
            ...
            with(this) {
                ...
                __d("JSSDKConfig", [], {
                    "features": {
                        ...
                        "allow_shadow_dom_for_apps_with_id": [520916077950649, 152351391599356],
                    ...
                    c.subscribe("init:post", function(a) {
                        ...
                        if (b("sdk.Runtime").getClientID() && b("sdk.Runtime").getUseCookie()) {
                            ...
                            if (a) {
                                ...
                                c != null && c.user_id != null && b("sdk.Runtime").setCookieUserID(c.user_id)
                            }
                        }
                    })
                }), 3);
                ...
                __d("ChatPluginStyleUtils", [], (function(a, b, c, d, e, f) {
                    ...
                    function F(a, b, c, d, e, f, i) {
                        c = c - A;
                        var j = q + A;
                        f ? (j = A, e === "none" ? i === "compact" ? j += r : j += q : i === "compact" ? j += h : j += g) : i === "compact" && (j = r + A);
                        f = j + b;
                        e = " bottom: " + f.toString() + "px;";
                ...
                __d("sdk.XFBML.CustomerChatNew", ["ChatPluginSDKPreLoggingUtils", "DOMEventListener", "IframePluginClass", "Log", "MPNExplicitUserInteractions", "MPNLocalState", "QueryString", "UrlMap", "getFacebookOriginForTarget", "performanceAbsoluteNow", "sdk.Content", "sdk.DOM", "sdk.DialogUtils", "sdk.Event", "sdk.UA", "sdk.WebStorage", "sdk.XD", "sdk.XFBML.CustomerChatWrapper", "sdk.cp.Actions", "sdk.cp.Animation", "sdk.cp.Constants", "sdk.cp.Storage", "sdk.createIframe"], (function(a, b, c, d, e, f, g) {
                    ...
                    a = function(a) {
                        ...
                        function b(b, c, e, f) {
                            ...
                            g.$CustomerChat13 = !1;
                            g.show = function(a) {
                                a === void 0 && (a = !0), g.$CustomerChat13 = !1, g.$CustomerChat1 != null && d("sdk.DOM").setStyle(g.$CustomerChat1, "display", "inline"), a && g.$CustomerChat25(g.$CustomerChat4), d("sdk.Event").fire("customerchat.show"), g.$CustomerChat27("show")
                            };
                            g.hide = function() {
                                g.$CustomerChat13 = !0, g.$CustomerChat1 != null && d("sdk.DOM").setStyle(g.$CustomerChat1, "display", "none"), g.$CustomerChat24(g.$CustomerChat4), d("sdk.Event").fire("customerchat.hide"), g.$CustomerChat27("hide")
                            };
                            g.showDialog = function() {
                                g.$CustomerChat1 != null && d("sdk.DOM").setStyle(g.$CustomerChat1, "display", "inline"), g.$CustomerChat25(g.$CustomerChat4), g.$CustomerChat27("showDialog")
                            };
                            g.hideDialog = function() {
                                g.$CustomerChat24(g.$CustomerChat4), g.$CustomerChat27("hideDialog")
                            };
                            g.update = function(a) {
                                var b;
                        ...
                        e.$CustomerChat18 = function(a) {
                            ...
                            this.$CustomerChat3 = c("sdk.createIframe")({
                                ...
                                onload: function() {
                                    d("ChatPluginSDKPreLoggingUtils").preLogging("chat_plugin_sdk_icon_iframe_load", b.params), b.$CustomerChat2 = j, b.$CustomerChat21(), b.$CustomerChat22(), window.setTimeout(function() {
                                        d("sdk.DOM").remove(i)
                                    }, 100)
                                }
                            });
                            ...
                            this.$CustomerChat8 = c("sdk.createIframe")({
                                ...
                                onload: function() {
                                    b.$CustomerChat9 = k, b.$CustomerChat21(), b.$CustomerChat22()
                                }
                            });
                            ...
                            this.$CustomerChat6 = c("sdk.createIframe")({
                                ...
                                onload: function() {
                                    b.$CustomerChat7 = l, b.$CustomerChat21(), b.$CustomerChat22()
                                }
                            });
                            d("sdk.Content").append(this.$CustomerChat6, g.contentRoot)
                        };
                        e.$CustomerChat22 = function() {
                            this.$CustomerChat2 !== null && this.$CustomerChat7 !== null && this.$CustomerChat9 !== null && this.$CustomerChat5 !== null && !this.$CustomerChat10 && (this.$CustomerChat10 = !0, this.inform("iframes_loaded"))
                        };
                        ...
                        e.$CustomerChat19 = function(a) {
                            ...
                            if (a && !this.$CustomerChat12) {
                                ...
                                e != c("sdk.cp.Constants").path.landingPage && e != c("sdk.cp.Constants").path.bubble && this.$CustomerChat23()
                            }
                            this.$CustomerChat13 && this.hide()
                        };
                        e.$CustomerChat20 = function(a) {
                            a = a.shouldHide;
                            a === "true" ? this.$CustomerChat24(this.iframe) : this.$CustomerChat25(this.iframe)
                        };
                        e.getParams = function() {
                            return {
                                allow_guests: "bool",
                        ...
                        e.$CustomerChat26 = function(a, b) {
                            ...
                            this.$CustomerChat11 === null ? c("getFacebookOriginForTarget")(function(a) {
                                d.$CustomerChat11 = a, f(d.$CustomerChat11)
                            }, e) : f(this.$CustomerChat11)
                        };
                        e.$CustomerChat17 = function(a) {
                            var b;
                            this.$CustomerChat26((b = this.$CustomerChat2) != null ? b : "", a)
                        };
                        e.$CustomerChat16 = function(a) {
                            var b;
                            this.$CustomerChat26((b = this.$CustomerChat5) != null ? b : "", a)
                        };
                        ...
                        e.$CustomerChat24 = function(a) {
                            ...
                            if (!this.$CustomerChat12) {
                                ...
                                c("sdk.cp.Constants").animationEvents.forEach(function(e) {
                                    var f = function(e) {
                                        b.$CustomerChat12 && (d("sdk.DOM").setStyle(a, "maxHeight", "0"), d("sdk.DOM").setStyle(a, "minHeight", "0"), c("sdk.cp.Constants").animationEvents.forEach(function(b) {
    ...
    i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script || "sdk.js") + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1005426871","namespace":"FB","message":"' + e.message + '"}}');
